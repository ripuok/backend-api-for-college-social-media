...
CREATE TABLE `likes` (
  ...
  KEY `id_idx` (`user_id`),
  KEY `photo_id_idx` (`update_id`),
  CONSTRAINT `id` FOREIGN KEY (`user_id`) REFERENCES `students` (`id`),
  CONSTRAINT `photo_id` FOREIGN KEY (`update_id`) REFERENCES `updates` (`photo_id`)
...
INSERT INTO `likes` VALUES (10,6,1,0000000001),(11,5,1,0000000001),(12,4,1,0000000001),(13,4,2,0000000001);
